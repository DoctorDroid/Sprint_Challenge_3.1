...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  I prefer any ambiguous code be commented   with an explanation and also that 
  variable names are descriptive enough to keep the readability of the code as 
  simple as possible.  
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  The use of containers would insure universal packaging of any code set to be deployed 
  for use on any operating system. Also while working on projects as a team, containers
  will ensure all participants are using the same dependencies and may make changes on 
  their prefered operating system without issue.
